# -*- coding: utf-8 -*-
"""
Created on Thu Dec 28 21:16:49 2017
...
class ISING(object):
    def __init__(self, _H_magnetic=0., _Temperature=2, _length=10):
    ...
    def MCstep(self,_system, _H=0., _T=2):  # sweep all spins -- Monte Carlo step
        for i in range(self.length):
