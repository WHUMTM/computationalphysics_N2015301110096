...
title('Relationship between angle and Cannon ball placement')
xlabel('angle')
xticks([0,np.pi/8,np.pi/4,3*np.pi/8,np.pi/2],[r'$0$',r'$+\pi/8$',r'$+\pi/4$',r'$+3\pi/8$',r'$+\pi/2$'])
ylabel('range/m')
ylim(0,30)
