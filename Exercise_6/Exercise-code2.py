...
ax1.set_ylabel(r'$\omega$'+'(radians/s)')
plt.text(0.25, 0.75, r'$\omega$'+'  versus  '+r'$\theta$'+'    '+r'$F_D=0.5$')
ax2=plt.subplot(122)
...
plt.text(1, 2.3, r'$\omega$'+'  versus  '+r'$\theta$'+'    '+r'$F_D=1.2$')
#ax3=plt.subplot(133)
