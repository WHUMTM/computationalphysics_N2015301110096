# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 14:40:03 2017
...
ax.set_title(r'Electric Potential Distribution Near Two Metal Plates')
ax.set_xlim(-1,1)
ax.set_ylim(-1,1)
ax.set_zlim(-1.2,1.2)
ax.contourf(X, Y, Z, zdir='z', offset=-1.2, cmap=plt.cm.rainbow)
plt.show()
...
plt.title(r'Electric Potential Distribution Near Two Metal Plates')
plt.show()
...
plt.title(r'Electric Field Distribution Near Two Metal Plates')
